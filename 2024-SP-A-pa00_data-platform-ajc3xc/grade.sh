...
custom_test_1_basic() {
    ...
    custom_test_score=0
    rm -f jupyter_out.txt
    # jupytext --execute bioinformatics.md
    ipython3 bioinformatics.py
    diff jupyter_out_goal.txt jupyter_out.txt && custom_test_score=100
    rm -f jupyter_out.txt
}
######## <- Custom tests ########
